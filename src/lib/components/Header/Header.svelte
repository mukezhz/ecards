<script lang="ts">
	...
	let hidden = true;
	const toggleHiddenMenu = () => (hidden = !hidden);
</script>
...
<header>
	...
	<div class="lg:hidden" class:hidden role="dialog" aria-modal="true">
		...
		>
			<div class="flex items-center justify-between">
				<button type="button" class="-m-2.5 rounded-md p-2.5" on:click={toggleHiddenMenu}>

...
<div>
	<div class="relative z-50 lg:hidden" role="dialog" aria-modal="true">
		<div class="fixed flex">
			<div class="relative mr-16 flex w-full max-w-xs flex-1" class:hidden>
				<div class="absolute left-full top-0 flex w-16 justify-center pt-5">
					<button type="button" class="-m-2.5 p-2.5" on:click={handleToggleSideBar}>
				...
				<div
					class="flex grow flex-col gap-y-5 overflow-y-auto bg-white px-6 pb-4 h-screen w-screen"
					class:hidden
				>
